    ...
    variable variants {
        ...
        super_monkey {
            ...
            loader_options {
                ...
                params {
                    { jittered_hit1 { ball_jitter_x 6 ball_start_y 9 ball_jitter_y 0 minplanks 1} }
                    { jittered_hit2 { ball_jitter_x 6 ball_start_y 9 ball_jitter_y 0 minplanks 2} }
                    { jittered_hit3 { ball_jitter_x 6 ball_start_y 9 ball_jitter_y 0 minplanks 3} }
                    { jittered_hit4 { ball_jitter_x 6 ball_start_y 9 ball_jitter_y 0 minplanks 4} }
                }
            }
        }
        ...
        monkey_mixer {
            ...
            loader_options {
                ...
                wrong_catcher_alpha { 1.0 }
                params {
                    { default { ball_jitter_x 6 ball_start_y 9 ball_jitter_y 0 } }
                }
            }
        }
