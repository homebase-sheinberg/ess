...
#
# DESCRIPTION
#   loader for circle protocol
#

namespace eval search::circles {
    proc loaders_init { s } {
        $s add_loader basic_search { nr nd targ_r dist_prop mindist targ_range targ_color } {
            set n_rep $nr
            set ndists $nd
            ...
            dl_set $g:dists_pos [::points::pickpoints $g:dists_n [dl_pack stimdg:targ_pos] $min_dist $max_y $max_y]
            ...
            if { [dl_sum $g:dists_n] } {
                ...
                foreach l "dists_xs dists_ys dist_rs dist_colors" {
                    dl_set $g:$l [dl_repeat [dl_llist [dl_llist]] $n_obs]
                }
            }
