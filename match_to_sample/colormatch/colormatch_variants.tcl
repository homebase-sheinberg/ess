    ...
    variable variants {
        noDistractor {
            ...
            loader_options {
                ...
                targ_scale 1.5
                transparency { {off 0.0} {0.05 0.05} {0.1 0.1} {0.15 0.15} {0.175 0.175} {0.2 0.2} {0.25 0.25} {0.3 0.3} {0.35 0.35} {0.4 0.4} {0.5 0.5} {0.6 0.6} {0.7 0.7} {0.8 0.8} {0.9 0.9} {mixed {0.0 0.2}} {full 1.0} }
            }
        }
        easy {
