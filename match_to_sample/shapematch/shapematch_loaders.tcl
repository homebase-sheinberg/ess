...
namespace eval match_to_sample::shapematch {
    proc loaders_init { s } {
	$s add_method setup_trials { n_rep targ_scale shape_choices shape_params } {
	    ...
	    dl_set $g:sample_control_points \
		[dl_choose $blob_table:control_points $sample_id]
	    dl_set $g:sample_nsteps \
		[dl_choose $blob_table:nsteps $sample_id]
	    ...
	    dl_set $g:match_control_points \
		[dl_choose $blob_table:control_points $match_id]
	    dl_set $g:match_nsteps \
		[dl_choose $blob_table:nsteps $match_id]
	    ...
	    dl_set $g:nonmatch_control_points \
		[dl_choose $blob_table:control_points $nonmatch_id]
	    dl_set $g:nonmatch_nsteps \
		[dl_choose $blob_table:nsteps $nonmatch_id]
