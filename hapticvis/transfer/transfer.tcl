...
namespace eval hapticvis::transfer {
    ...
    proc protocol_init { s } {
        ...
        $s add_method haptic_show { shape_id a { hand 1 } } {
            ...
            set zero_pt -177.4
            if {$hand == 0} {
                set res [rest::get $url [list function pick_and_place hand 0 xoffset zero_pt+25 left_id $shape_id left_angle $angle return_duplicates 0 dont_present 1 use_dummy 1 dummy_ids 20302,2001 reset_dial $follow_dial dial_following $follow_dial pattern_following $follow_pattern
                ]
                ]
            } else {
                set res [rest::get $url [list function pick_and_place hand 0 xoffset zero_pt-25 left_id $shape_id left_angle $angle return_duplicates 0 dont_present 1 use_dummy 1 dummy_ids 20302,2001 reset_dial $follow_dial dial_following $follow_dial pattern_following $follow_pattern
