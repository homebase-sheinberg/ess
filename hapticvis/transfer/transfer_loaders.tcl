    ...
    proc loaders_init { s } {
        ...
        $s add_method setup_trials { db_prefix subject_id subject_set n_per_set trial_type shape_scale noise_type n_rep rotations joystick_side subject_handedness have_feedback have_distractors { use_dists 0 } } {
            ...
            if { $have_distractors == 0 } {
              ...
              # create choice center information for final
              dl_local distractor_angle_x [dl_mult [expr (2*$::pi)/8.] 0]
              dl_local distractor_angle_y [dl_mult [expr (2*$::pi)/8.] 2]
              ...
              dl_local both_centers [dl_combine [dl_transpose $choice_centers] [dl_transpose $distractor_centers]]
